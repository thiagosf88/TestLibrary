 ...
 * @author Thiago
 */
public class MatrixOperation extends PerformanceTest<Double> implements PerformanceTestInterface{

	public MatrixOperation(PerformanceTestActivity activity, double level) {
	...
	public void execute() {
		...
		testAMatrixOperationLinpack(this.getLevel());
	 ...
	 */
	void testAMatrixOperationLinpack(double level) {
