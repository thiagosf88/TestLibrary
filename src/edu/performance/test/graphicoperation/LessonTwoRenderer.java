...
public class LessonTwoRenderer implements GLSurfaceView.Renderer 
{
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) 
	{
		...
		new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Thread.sleep(((LessonThreeActivity)context).getMAX_TIME_MS());
				...
				((LessonThreeActivity)context).setResult(LessonThreeActivity.RESULT_OK, mIntent);
				System.out.println("saindo. Is it the last? " + false );
				((LessonThreeActivity)context).finish();
	...
	public void onDrawFrame(GL10 glUnused) 
	{
        ...
        drawingSomeCubes(((LessonThreeActivity)context).getLevel(), angleInDegrees);
