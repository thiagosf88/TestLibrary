 ...
 */
public class CubeColorGLES2Renderer implements GLSurfaceView.Renderer 
{
	
	private final Context context;
	/** Used for debug logs. */
	private static final String TAG = "CubeColorGLES2Renderer";
	 ...
	 */
	public CubeColorGLES2Renderer(Context context)
	{	
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) 
	{
		...
		new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Thread.sleep(((CubeColorGLES2Activity)context).getMAX_TIME_MS());
	...
	public void onDrawFrame(GL10 glUnused) 
	{
        ...
        drawingSomeCubes(((CubeColorGLES2Activity)context).getLevel(), angleInDegrees);
