...
public class Camera {
	...
	public Camera(/*Player PlayerData, */CamType camtype)
	{
		...
		_target.v[0] = 360;//PlayerData.getXpos();
		_target.v[1] = 180;//PlayerData.getYpos();
		_target.v[2] = 0.0f;
		
		_cam.v[0] = 360 + CAM_CIRCLE_DIST;//PlayerData.getXpos()  + CAM_CIRCLE_DIST;
		_cam.v[1] = 180;//PlayerData.getYpos();
	...
	private void playerCamera(/*Player PlayerData,*/ long CurrentTime, long dt)
	{
		...
		x =360; //SystemClock.currentThreadTimeMillis()% 720;//PlayerData.getXpos();
		y = 180;//System.nanoTime() * dt %720;//PlayerData.getYpos();
